	  ...
	  public:
		...
		class media_top_type
		{
		  ...
		  public:
			...
			/// @exception media_type::parsing_error If remainder of string is not alphanumeric or '!', '#', '$', '&', '-',
			/// '^', '_', '.', '+'.
			[[nodiscard]] constexpr media_top_type(std::string&& input) : value {std::move(input)} { verify(); }
			[[nodiscard]] constexpr media_top_type(const std::string& input) : value {input} { verify(); }
			[[nodiscard]] constexpr media_top_type(const std::string_view input) : media_top_type {std::string {input}} { }
			[[nodiscard]] constexpr media_top_type(const char* const input) : media_top_type {std::string {input}} { }
		...
		class media_tree
		{
		  ...
		  public:
			...
			[[nodiscard]] constexpr media_tree(std::string&& input) : value {std::move(input)} { verify(); }
			[[nodiscard]] constexpr media_tree(const std::string& input) : value {input} { verify(); }
			[[nodiscard]] constexpr media_tree(const std::string_view input) : media_tree {std::string {input}} { }
			[[nodiscard]] constexpr media_tree(const char* const input) : media_tree {std::string {input}} { }
			...
			[[nodiscard]] constexpr auto is_standards_tree() const noexcept -> bool { return value.empty(); }
		};
		...
		class media_subtype
		{
		  ...
		  public:
			...
			/// @exception media_type::parsing_error If remainder of string is not alphanumeric or '!', '#', '$', '&', '-',
			/// '^', '_', '.', '+'.
			[[nodiscard]] constexpr media_subtype(std::string&& input) : value {std::move(input)} { verify(); }
			[[nodiscard]] constexpr media_subtype(const std::string& input) : value {input} { verify(); }
			[[nodiscard]] constexpr media_subtype(const std::string_view input) : media_subtype {std::string {input}} { }
			[[nodiscard]] constexpr media_subtype(const char* const input) : media_subtype {std::string {input}} { }
		...
		class media_suffix
		{
		  ...
		  public:
			...
			/// @exception media_type::parsing_error If remainder of string is not alphanumeric or '!', '#', '$', '&', '-',
			/// '^', '_'.
			[[nodiscard]] constexpr media_suffix(std::string&& input) : value {std::move(input)} { verify(); }
			[[nodiscard]] constexpr media_suffix(const std::string& input) : value {input} { verify(); }
			[[nodiscard]] constexpr media_suffix(const std::string_view input) : media_suffix {std::string {input}} { }
			[[nodiscard]] constexpr media_suffix(const char* const input) : media_suffix {std::string {input}} { }
		...
		[[nodiscard]] constexpr media_type(const std::string_view input) : media_type {parser(input)} { };
		[[nodiscard]] constexpr media_type(const char* const input) : media_type {std::string_view {input}} { };
		[[nodiscard]] constexpr media_type(const std::string& input) : media_type {std::string_view {input}} { };
		...
		{
		  public:
			[[nodiscard]] explicit constexpr parsing_error(const std::string& message) noexcept : std::invalid_argument {message} { };
			[[nodiscard]] explicit constexpr parsing_error(const char* const message) noexcept : std::invalid_argument {message} { };
		};
	};
